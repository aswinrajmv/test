def connect_visa_Keithley2380(baud):
...
def main():
	dmm = connect_visa_Keithley2380()
	setup_dmm_Keithley2380(dmm)
	print("Done.")	
...
def wait_for_opc(inst, timeout=30):
	print("Keithley 2380 OPC not implemented!")
	return False
	# start = time.time()
	# while True:
	...
	# 		print("Keithley 2380 OPC Failed")
	# 		return False
	# 	#print(".")
	# 	time.sleep(0.1)
	# return True
